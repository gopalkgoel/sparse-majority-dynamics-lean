...
/-! Finite density substitution retaining the actual `n*p²` budget. -/
noncomputable section
namespace MajorityDynamics.Combinatorics.DegreeRatios

theorem density_error_bound_budget {n p u d h q t K L B : ℝ}
    ...
    |(-d * Real.log q - (h - d) * Real.log (1 - q)) +
        d * Real.log p - u| ≤ K * L + 4 * K ^ 2 + 2 + 8 * B := by
